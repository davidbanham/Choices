...
/*!***********************************!*\
  ...
  \***********************************/
/*! no static exports found */function(e,t,n){var i=n(/*! ./bitap_score */"./src/bitap/bitap_score.js"),r=n(/*! ./bitap_matched_indices */"./src/bitap/bitap_matched_indices.js");e.exports=function(e,t,n,o){for(var s=o.location,a=void 0===s?0:s,c=o.distance,l=void 0===c?100:c,u=o.threshold,h=void 0===u?.6:u,d=o.findAllMatches,f=void 0!==d&&d,p=o.minMatchCharLength,v=void 0===p?1:p,m=a,g=e.length,y=h,_=e.indexOf(t,m),b=t.length,E=[],S=0;S<g;S+=1)E[S]=0;if(-1!==_){var O=i(t,{errors:0,currentLocation:_,expectedLocation:m,distance:l});if(y=Math.min(O,y),-1!==(_=e.lastIndexOf(t,m+b))){var I=i(t,{errors:0,currentLocation:_,expectedLocation:m,distance:l});y=Math.min(I,y)}}_=-1;for(var w=[],C=1,T=b+g,x=1<<b-1,A=0;A<b;A+=1){for(var k=0,L=T;k<L;){i(t,{errors:A,currentLocation:m+L,expectedLocation:m,distance:l})<=y?k=L:T=L,L=Math.floor((T-k)/2+k)}T=L;var j=Math.max(1,m-L+1),P=f?g:Math.min(m+L,g)+b,D=Array(P+2);D[P+1]=(1<<A)-1;for(var M=P;M>=j;M-=1){var N=M-1,F=n[e.charAt(N)];if(F&&(E[N]=1),D[M]=(D[M+1]<<1|1)&F,0!==A&&(D[M]|=(w[M+1]|w[M])<<1|1|w[M+1]),D[M]&x&&(C=i(t,{errors:A,currentLocation:N,expectedLocation:m,distance:l}))<=y){if(y=C,(_=N)<=m)break;j=Math.max(1,2*m-_)}}if(i(t,{errors:A+1,currentLocation:m,expectedLocation:m,distance:l})>y)break;w=D}return{isMatch:_>=0,score:0===C?.001:C,matchedIndices:r(E,v)}}},"./src/bitap/index.js":
/*!****************************!*\
  !*** ./src/bitap/index.js ***!
  \****************************/
